...
import com.spotlight.platform.userprofile.api.web.exceptionmappers.IllegalArgumentExceptionMapper;
...
public class UserProfileApiApplication extends Application<UserProfileApiConfiguration> {
    ...
    private void registerExceptionMappers(Environment environment) {
        ...
        environment.jersey().register(getInstance(IllegalArgumentExceptionMapper.class));
    }
